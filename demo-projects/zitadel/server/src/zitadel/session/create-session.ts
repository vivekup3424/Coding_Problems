...
export async function createSession(domain: string, token: string, userId: string): Promise<any> {
    try {
        ...
        fs.appendFile("session-create.json", JSON.stringify(response.data, null, 2) + "\n");
