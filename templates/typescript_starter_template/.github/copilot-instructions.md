...
- [x] Clarify Project Requirements
	<!-- TypeScript npm project with tsx, tsc, and other utilities specified by user. -->
...
- [x] Scaffold the Project
	...
	Use '.' as the working directory.
	If no appropriate projectType is available, search documentation using available tools.
	Otherwise, create the project structure manually using available file creation toolsPath of Exile.
	-->
