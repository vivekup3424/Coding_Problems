...
Example 1:
    ...
    Output: "Radiant"
    Explanation:
        The senator coming from Radiant at index 0 first bans the senator
        coming from Dire in the round 1.
        And the senator coming from Radiant at index 1 elected as the
        winner in round 2.
...
Example 2:
    ...
    Explanation:
        The senator coming from Radiant at index 0 first bans the senator
        coming from Dire in the round 1.
        And the senator coming from Dire at index 2 bans the senator
        coming from Radiant at index 1 in round 1.
        And the senator coming from Dire at index 2 wins in round 2.
